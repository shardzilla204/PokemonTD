...
public partial class InventoryTeamSlot : NinePatchRect
{
	[Export]
	...
	public override void _Ready()
	{
		...
		_interactComponent.Interacted += (isLeftClick, isPressed, isDoubleClick) =>
		{
			...
			PokémonTD.Signals.EmitSignal(Signals.SignalName.InventoryTeamSlotRemoved, Pokémon, ID);
		};
	}
