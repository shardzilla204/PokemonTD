...
public partial class PokemonMoveset : Node
{
    ...
    public PokemonMove GetRandomPokemonMove()
    {
        ...
        int randomValue = RNG.RandiRange(0, PokemonMoves.Count - 1);
        return PokemonMoves[randomValue];
    }

    public PokemonMove GetPokemonMove(string pokemonMoveName)
    {
        return PokemonMoves.Find(pokemonMove => pokemonMove.Name == pokemonMoveName);
    }
}